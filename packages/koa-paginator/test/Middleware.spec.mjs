...
describe('::Middleware', function () {
	it('should throw if bad init.', function () {
		assert.throws(() => Paginator.Middleware.Page(), {
			name: 'TypeError',
	...
	it('should throw if bad onError.', function () {
		assert.throws(() => Paginator.Middleware.Page(() => {}, null), {
			name: 'TypeError',
	...
	describe('>middleware()', function () {
		...
		this.beforeAll(async function start() {
			...
			app.use(Paginator.Middleware.Page((ctx, page) => {
